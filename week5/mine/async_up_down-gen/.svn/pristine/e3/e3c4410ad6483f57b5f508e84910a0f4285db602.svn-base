...
parser = argparse.ArgumentParser(description="ASYC_UP_DOWN design generator")
parser.add_argument(
    "--specfile",
    required=True,
...
if jsonSpec["generator"] != "async_up_down-gen":
    print('Error: Generator specification must be "async_up_down-gen".')
    sys.exit(1)
...
mFilePublic1 = genDir + args.platform + ".model_ASYC_UP_DOWN"
